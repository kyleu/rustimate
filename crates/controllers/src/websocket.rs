...
impl ServerSocket {
  ...
  fn handle_error(&self, e: &rustimate_core::Error, wsc: &mut ws::WebsocketContext<Self>) {
...
pub fn connect(
  session: Session, cfg: web::Data<AppConfig>, req: HttpRequest, key: web::Path<String>, stream: web::Payload
  ...
  let handler = MessageHandler::new(id, key.to_string(), ctx);
